...
```
npm create cloudflare@latest -- --template=cloudflare/templates/dawn-snow-8f86
```

A live public deployment of this template is available at [https://dawn-snow-8f86.templates.workers.dev](https://dawn-snow-8f86.templates.workers.dev)
